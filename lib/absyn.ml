...
let pp_pos (f : Format.formatter) (a : Lexing.position) =
  match a with
  | { pos_fname; pos_lnum; pos_bol; pos_cnum } ->
      Format.pp_print_string f ("line: " ^ string_of_int pos_lnum)
...
and typedec = { name : symbol; ty : ty; pos : pos } [@@deriving show]
