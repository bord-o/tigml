...
let%test "if-then without else returns non-unit" =
  test_program "test15.tig" false

let%test "invalid recursive type cycle" = test_program "test16.tig" false

let%test "interrupted recursive type definition" =
  test_program "test17.tig" false

let%test "interrupted recursive function definition" =
  test_program "test18.tig" false
